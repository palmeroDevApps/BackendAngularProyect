...
var controller = {
    ...
    getImageFile: function(req, res) { //funcion para obtener una imagen, bueno, es un get jaja
        var file = req.params.image; //archivo de imagen
        var path_file = './uploads/' + file; //directorio de la imagen 
